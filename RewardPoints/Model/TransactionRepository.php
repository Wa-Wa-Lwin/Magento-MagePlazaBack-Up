...
use Mageplaza\RewardPoints\Model\ResourceModel\Transaction\CustomCollectionFactory as TransactionCollectionFactory;
...
class TransactionRepository implements TransactionRepositoryInterface
{
    ...
    public function getListByCustomerId(SearchCriteriaInterface $searchCriteria, $customerId)
    {
        ...
        $searchResult = $this->transactionCollectionFactory->create()->addFieldToFilter('customer_id', $customerId);
       ...
       foreach($searchResult->getItems() as $item) {
            $item->setCreatedAt($this->formatDate($item->getCreatedAt()));
            $item->setExpirationDate($this->formatDate($item->getExpirationDate()));
       }
       $searchResults->setItems($searchResult->getItems());
       $searchResults->setTotalCount($searchResult->getSize());
