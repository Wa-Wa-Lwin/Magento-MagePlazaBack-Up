...
class Wishlist implements PostManagementInterface
{
    ...
    public function getWishlistDetails($customerId, $wishlistItemId)
    {
        ...
        $item = $this->itemCollectionFactory->create()
            ->addFieldToSelect('qty')
            ->join(['wishlist' => 'wishlist'], 'wishlist.wishlist_id = main_table.wishlist_id', 'customer_id')
            ->join(['wishlist_item_option' => 'wishlist_item_option'], 'wishlist_item_option.wishlist_item_id = main_table.wishlist_item_id', ['value', 'code', 'product_id', 'wishlist_item_id'])
            ->join(['wishlist_item' => 'wishlist_item'], 'wishlist_item.wishlist_item_id = main_table.wishlist_item_id', ['product_id', 'qty'])
