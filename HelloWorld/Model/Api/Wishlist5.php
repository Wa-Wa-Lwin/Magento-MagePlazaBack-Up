...
class Wishlist implements PostManagementInterface
{
    ...
    /**
     * @var WishlistApiInterface
     */
    protected $wishlistApiInterface;
...
// use MIT\Product\Api\WishlistApiInterface; 
    ...
    public function __construct(
        ...
        \MIT\Product\Api\ProductApiInterface $productApiInterface, 

        \MIT\Product\Api\Data\WishlistInterface $wishlistInterface,
        \MIT\Product\Api\WishlistApiInterface $wishlistApiInterface,
        ...
        $this->wishlistApiInterface =$wishlistApiInterface;
    ...
    public function getWishlistDetailForCustomer($customerId, SearchCriteriaInterface $searchCriteria)
    {
       ...
       // $productList = $this->customProduct->getList($searchCriteria);
        ...
        // $productList = $this->wishlistApi->getList(0,$searchCriteria);
        // $product = $productList->getItems(); 

        //$product = $productList->getItems();

        //$product = $this->wishlistApiInterface->wishlistInterface->getItems();

        //$product = $productList->wishlistInterface->getItems();
        ...
        // //foreach ($productList->getList()->getItems() as $productItem) {
