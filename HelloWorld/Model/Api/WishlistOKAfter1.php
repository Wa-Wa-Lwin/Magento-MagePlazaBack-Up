    ...
    public function getWishlistDetailForCustomer($customerId, SearchCriteriaInterface $searchCriteria)
    {
        ...
        foreach ($wishlist_collection as $item)
        {
            ...
            if ($parentId === $childId){
                ...
                $wishlistItemIdList[$parentId] = array($childId);
               // var_dump("child id is different."); 
            }
        }
        ...
        foreach ($product as $productItem) {
            ...
            $setWishlistItemId = $productItem->getWishlistItemId();

            var_dump("setWishlistItemId is ".$setWishlistItemId); 
            // $wishlistItemIdList[$productItemId][0];
            $setQty = $productItem->getWishlistQty(); 
            // $wishlistItemIdList[$productItemId][1];


            if (isset($wishlistItemIdList[$productItemId])) {                            
                $childId = $wishlistItemIdList[$productItemId][0];                   
                if (isset($childId)) {
